...
interface GithubButtonProps
  ...
  roundStars?: boolean;
  /** Whether to use fixed width to prevent layout shift */
  fixedWidth?: boolean;
...
function GithubButton({
  ...
  const stableInViewOptions = React.useMemo(() => inViewOptions, [inViewOptions]);
  const isInView = useInView(ref, stableInViewOptions);
