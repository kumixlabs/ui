...
import { META_THEME_COLORS, THEME_MODES } from "@kumix/utils";

/**
 * Calculates and applies the HTML `theme-color` meta tag from `next-themes`.
 * The returned setter can be used for temporary manual overrides.
 *
