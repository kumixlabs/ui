...
export const dataGridCellSelectionCellClasses = cn(
  ...
  "data-[cell-edge-left]:before:border-s data-[cell-edge-right]:before:border-e data-[cell-edge-top]:before:border-t data-[cell-edge-bottom]:before:border-b",
...
function DataGridProvider<TData extends object>({
  ...
  }, [pageKey, cellSelectionOn, table.atoms.cellSelection]);
  ...
  const autoSize = useMemo(() => createDataGridAutoSizeController(() => tableRef.current), []);
  ...
  const value = useMemo(
    ...
    [autoSize, props.recordCount, props.isLoading, gridId],
  );
