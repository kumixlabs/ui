...
function DataGridTableVirtualStatusRow<TData extends object>({
  ...
  return (
    <DataGridTableVirtualUtilityRow
      table={table}
      centerCellClassName={cn("py-4 text-center text-muted-foreground text-sm", className)}
    >
      {children}
    </DataGridTableVirtualUtilityRow>
  );
...
function DataGridTableVirtual<TData extends object>({
  ...
  }, [columnVirtualizationActive, columnVirtualizer]);
