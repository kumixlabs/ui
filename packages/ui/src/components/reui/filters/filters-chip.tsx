...
import { FilterMenu, useFilterOptions, useFilterValueResolution } from "./filters-editors";
import {
  collapseFilterPath,
  FILTER_MENU_CLASS,
...
import { findFilterNode, isFilterGroup } from "./filters-query";
import type {
  FilterEditorProps,
  FilterField,
  FilterGroupNode,
...
function FilterPathSeparator() {
  return (
    <ChevronRightIcon
      ...
      className="mx-[3px] inline-block size-3 shrink-0 self-center align-[calc(0.3635em-0.375rem)] text-muted-foreground"
    />
  );
}
