...
import type { CascaderItemState, CascaderProps } from "../cascader/cascader";
import {
  Cascader,
  CascaderEmpty,
  CascaderList,
...
import { useCascaderActions, useCascaderHighlight } from "../cascader/cascader-context";
import { CascaderFooter } from "../cascader/cascader-footer";
import { CascaderItems } from "../cascader/cascader-item";
import { CascaderInput, CascaderNav } from "../cascader/cascader-nav";
import type { CascaderActionItem, CascaderNode } from "../cascader/cascader-types";
import {
...
export function FilterTextEditor<V, O>({
  ...
  return (
    ...
    <EditorPanel className={cn("w-72 min-w-0 max-w-[calc(100vw-2rem)]", field.className)}>
