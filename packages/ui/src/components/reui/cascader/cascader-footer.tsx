...
import type { CascaderActionItem } from "./cascader-types";
...
function CascaderFooter({ className, children, onKeyDown, ...props }: CascaderFooterProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col gap-0.5 border-border/60 border-t",
      ...
      >
        <PopoverPrimitive.Popup
          ...
          className={cn(
            ...
            "flex min-w-48 max-w-(--available-width) flex-col gap-0.5 outline-hidden",
            CASCADER_LIST_PAD_CLASS,
            "p-(--cascader-list-pad,4px)",
            className,
          )}
