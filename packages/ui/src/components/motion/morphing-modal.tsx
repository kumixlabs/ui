        ...
        <PresenceGate key="backdrop">
          {({ gate }) => (
            <motion.button
              ...
              {...gate}
              onClick={onClose}
              className="pointer-events-auto fixed inset-0 z-80 bg-background/5 [-webkit-backdrop-filter:blur(14px)_saturate(140%)] [backdrop-filter:blur(14px)_saturate(140%)]"
            />
          )}
        </PresenceGate>
      ) : null}
