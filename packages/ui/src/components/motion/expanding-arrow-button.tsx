...
import { type FocusEvent, forwardRef, type MouseEvent, type ReactNode, useState } from "react";
import { cn } from "cn";
    ...
    return (
      ...
      >
        ...
        <motion.span
          ...
          className={cn(
            "relative z-0 mr-5 ml-[76px] whitespace-nowrap font-medium text-lg tracking-[-0.02em]",
            labelClassName,
          )}
        >
          {children}
