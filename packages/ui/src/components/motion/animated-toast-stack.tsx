            ...
            <div className={cn("min-w-0 flex-1", classNames?.content)}>
              <AnimatePresence mode="popLayout" initial={false}>
                ...
                >
                  ...
                  {toast.description ? (
                    <p
                      className={cn(
                        "mt-0.5 line-clamp-2 text-muted-foreground text-xs leading-4",
              ...
              {toast.action ? (
                <button
                  ...
                  className={cn(
                    "mt-2 inline-flex h-7 items-center rounded-full bg-primary/6 px-3 font-medium text-foreground text-xs transition-colors hover:bg-primary/10",
                    classNames?.action,
                  )}
                >
                  {toast.action.label}
