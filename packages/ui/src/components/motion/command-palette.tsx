        ...
        <PresenceGate key="backdrop">
          {({ gate }) => (
            <motion.button
              ...
              className="pointer-events-auto fixed inset-0 z-100 bg-background/5 [-webkit-backdrop-filter:blur(12px)_saturate(140%)] [backdrop-filter:blur(12px)_saturate(140%)]"
            />
          )}
        </PresenceGate>
      ) : null}
