  ...
  return (
    ...
    >
      <motion.output
        ...
        style={style}
        className={cn(
          "flex size-full min-w-0 items-center justify-center overflow-hidden rounded-full border border-transparent bg-transparent bg-clip-padding px-4 font-semibold text-foreground text-lg tabular-nums",
          className,
        )}
      >
