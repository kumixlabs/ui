  ...
  function HoldActionButton(
    ...
    return (
      <motion.button
        ...
        className={cn(
          "relative inline-grid h-16 min-w-72 touch-none place-items-center overflow-hidden rounded-(--hold-radius) bg-primary px-8 text-primary-foreground",
          "[--hold-radius:22px]",
          TOUCH_GESTURE_CLASS,
      ...
      >
            ...
            {!reduce ? (
              type === "horizontal" ? (
                <motion.svg
                  ...
                  className="absolute top-0 -right-5 h-[200%] w-6 text-sky-400"
                >
                  <path
        ...
        <span
          className={cn(
            "relative z-10 grid place-items-center font-medium text-base tracking-[-0.01em]",
            labelClassName,
          )}
        >
          <motion.span
