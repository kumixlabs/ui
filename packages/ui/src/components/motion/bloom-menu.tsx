        ...
        <AnimatePresence initial={false} mode="popLayout">
          {open ? (
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between border-border border-b px-4 py-3">
                  <span className="font-medium text-muted-foreground text-sm">Create</span>
                  <button
                    type="button"
            ...
            <motion.button
              ...
              className="inline-flex h-11 w-36 items-center justify-center border border-border bg-card font-medium text-foreground text-sm"
            >
